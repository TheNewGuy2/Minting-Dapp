...
// log
import { fetchData } from "../data/dataActions5";

const connectRequest = () => {
  return {
    type: "CONNECTION_REQUEST_5",
  };
};

const connectSuccess = (payload) => {
  return {
    type: "CONNECTION_SUCCESS_5",
    payload: payload,
  };
};
...
const updateAccountRequest = (payload) => {
  return {
    type: "UPDATE_ACCOUNT_5",
    payload: payload,
  };
};

export const configurations = async () => {
  const abiResponse = await fetch("/config/abi5.json", {
    headers: {
