...
// log
import { fetchData } from "../data/dataActions3";

const connectRequest = () => {
  return {
    type: "CONNECTION_REQUEST_3",
  };
};

const connectSuccess = (payload) => {
  return {
    type: "CONNECTION_SUCCESS_3",
    payload: payload,
  };
};
...
export const connect = () => {
  return async (dispatch) => {
    ...
    const abiResponse = await fetch("/config/abi3.json", {
      headers: {
