...
function animate() {
  ...
  if (distractionTimer <= 0) {
    ...
    if (distractedFlag == true) {
      ...
      var tempX = randomInt(
        mouse.x + eyeposx + r - 200,
        mouse.x + eyeposx + r + 200
      );
      var tempY = randomInt(
        mouse.y + eyeposx + r - 200,
        mouse.y + eyeposx + r + 100
      );
...
function updateEyeParts() {
  ...
  var rgbString =
    "rgb(" +
    Math.round(eyeColor[0]) +
    "," +
    Math.round(eyeColor[1]) +
    "," +
    Math.round(eyeColor[2]) +
    ")";
  ...
  // top lid
  lids.css("border-top", lidTop.pos + "px solid " + "#ceab5e");

  // bottom lid
  lids.css("border-bottom", lidBottom.pos + "px solid " + "#ceab5e");
